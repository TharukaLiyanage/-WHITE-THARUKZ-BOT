# This file is part of White Tharukz (Telegram Bot)
...
from White Tharukz.config import get_bool_key, get_int_key, get_list_key, get_str_key
from White Tharukz.services.telethon import tbot
from White Tharukz.utils.logger import log
from White Tharukz.versions import White_Tharukz_V

log.info("----------------------------")
log.info("|      White Tharukz      |")
log.info("----------------------")
log.info("Version: " + White_Tharukz_V)

...
from White Tharukz import BOT_USERNAME, dp
from White Tharukz.config import get_bool_key
from White Tharukz.modules.error import parse_update
from White Tharukz.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("White Tharukz.utils.filters." + module_name)

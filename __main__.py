...
from White Tharukz import TOKEN, bot, dp
from White Tharukz.config import get_bool_key, get_list_key
from White Tharukz.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
from White Tharukz.utils.logger import log
...
if get_bool_key("LOAD_MODULES"):
    ...
    for module_name in modules:
        ...
        imported_module = import_module("White Tharukz.modules." + module_name)
...
import_module("White Tharukz.modules.pm_menu")
# Import misc stuff
import_module("White Tharukz.utils.exit_gracefully")
if not get_bool_key("DEBUG_MODE"):
    import_module("White Tharukz.utils.sentry")
